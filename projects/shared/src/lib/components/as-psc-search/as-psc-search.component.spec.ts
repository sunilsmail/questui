...
describe('AsPscSearchComponent', () => {
  let component: AsPscSearchComponent;
  let fixture: ComponentFixture<AsPscSearchComponent>;
  let userLocationService: UserCurrentLocationService;
  let googleService: GoogleMapsService;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [AsPscSearchComponent],
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AsPscSearchComponent);
