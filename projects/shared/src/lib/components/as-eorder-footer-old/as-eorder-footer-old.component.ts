...
@Component({
  selector: 'as-eorder-footer-old',
  templateUrl: './as-eorder-footer-old.component.html',
  styleUrls: ['./as-eorder-footer-old.component.scss']
})
export class AsEorderFooterOldComponent implements OnInit,OnChanges   {
  ...
  ngOnChanges() {
    if(this.finalStep){
      // this.continue_btn_text = this.i18n('Show Summary');
