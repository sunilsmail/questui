import { ChangeDetectionStrategy, Component, ElementRef, EventEmitter, OnChanges, OnDestroy, OnInit, Output, ViewChild } from '@angular/core';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { of, Observable, Subject, Subscription } from 'rxjs';
import {
  catchError, debounceTime, distinctUntilChanged,
  filter, map, mergeMap, startWith, switchMap, takeUntil, tap
} from 'rxjs/operators';
import {
...
@Component({
  selector: 'as-address',
  templateUrl: './as-address.component.html',
  styleUrls: ['./as-address.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class AsAddressComponent implements OnInit, OnChanges, OnDestroy {
  ...
  onOptionSelect(option: GoogleAutocompletePrediction) {
    // this.addressForm.reset(); TODO need to uncomment this to reset address fields on address selection
  ...
  onStateselection(state) {
    ...
    } else if (state.value && zipCodeFieldControl.value) {
