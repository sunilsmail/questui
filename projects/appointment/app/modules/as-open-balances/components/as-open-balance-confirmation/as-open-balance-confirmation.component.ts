...
@Component({
  selector: 'as-open-balance-confirmation',
  templateUrl: './as-open-balance-confirmation.component.html',
  styleUrls: ['./as-open-balance-confirmation.component.scss']
})
export class AsOpenBalanceConfirmationComponent implements OnInit {
  content = homeContent;
