...
import { AsOpenBalanceConfirmationComponent } from './as-open-balance-confirmation.component';
...
describe('AsOpenBalanceConfirmationComponent', () => {
  let component: AsOpenBalanceConfirmationComponent;
  let fixture: ComponentFixture<AsOpenBalanceConfirmationComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [AsOpenBalanceConfirmationComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AsOpenBalanceConfirmationComponent);
